...
function updateFloatingFilterParent(params, model) {
  params.parentFilterInstance((instance) => {
    ((instance instanceof import_ag_grid_community5.ProvidedFilter ? instance.setModel(model, true) : instance.setModel(model)) || import_ag_grid_community5.AgPromise.resolve()).then(() => {
...
function warnReactiveCustomComponents(gridId) {
  (0, import_ag_grid_community6._warnForGrid)(gridId, 231);
}
...
var HeaderRowComp = ({
  ...
  const [tabIndex, setTabIndex] = (0, import_react11.useState)(
    () => (0, import_ag_grid_community10._isHeaderFocusSuppressed)(beans) ? void 0 : gos.get("tabIndex")
  );
...
var useJsCellRenderer = (showDetails, showTools, eCellValue, cellValueVersion, jsCellRendererRef, eGui, suppressInlineEditRenderer = false, onRendererDestroyed) => {
  ...
  const onRendererDestroyedRef = (0, import_react18.useRef)(onRendererDestroyed);
  onRendererDestroyedRef.current = onRendererDestroyed;
  const destroyCellRenderer = (0, import_react18.useCallback)((resetTooltip = true) => {
...
var CellComp = ({
  ...
  const resetCellRendererTooltip = (0, import_react20.useCallback)(() => cellCtrl.resetCellRendererTooltip(), [cellCtrl]);
...
var GridComp = ({ context }) => {
  ...
  const ariaDescriptionRef = (0, import_react25.useRef)(null);
  ...
  return /* @__PURE__ */ import_react25.default.createElement("div", { ref: setRef2, className: rootWrapperClasses, style: topStyle, role: "presentation" }, /* @__PURE__ */ import_react25.default.createElement("div", { className: "ag-aria-description-container", ref: ariaDescriptionRef }), /* @__PURE__ */ import_react25.default.createElement("div", { className: rootWrapperBodyClasses, ref: setGridBodyParent, role: "presentation" }, initialised && eGridBodyParent && !context.isDestroyed() && /* @__PURE__ */ import_react25.default.createElement(BeansContext.Provider, { value: context.getBeans() }, /* @__PURE__ */ import_react25.default.createElement(
  ...
  for (const propKey of Object.keys(nextProps)) {
    if (excludeReactCompProps.has(propKey)) {
      if (deprecatedReactCompProps.has(propKey)) {
        if (gridId) {
          (0, import_ag_grid_community21._warnForGrid)(gridId, 274, { prop: propKey });
        } else {
          (0, import_ag_grid_community21._warnWithoutAttribution)(274, { prop: propKey });
        }
      }
      continue;
    }
